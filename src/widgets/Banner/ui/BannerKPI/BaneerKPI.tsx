...
const BannerKPI = (props: BannerKPIProps) => {
  ...
  return (
    <ul className={classNames(cls.banner, {}, [className])}>
      <UiIcons.leftLine type={"null"} className={cls.banner__vectore_left_bottom} />
      <UiIcons.leftLine type={"null"} className={cls.banner__vectore__left_top} />
      ...
      <UiIcons.rightLine type={"null"}className={cls.banner__vector_right_top} />
      <UiIcons.rightLine type={"null"} className={cls.banner__vectore_right_bottom} />
    </ul>
  );
};
